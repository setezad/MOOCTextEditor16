...
public class EfficientDocument extends Document {
	...
	private boolean isWord(String tok)
	{
		...
		return !(tok.indexOf("!") >=0 || tok.indexOf(".") >=0 || tok.indexOf("?")>=0 || tok.indexOf(";")>=0);
	}
	...
	public static void main(String[] args)
	{
		...
		testCase(new EfficientDocument("Lorem ipsum dolor sit amet, qui ex choro quodsi moderatius, nam dolores explicari forensibus ad."),
		         32, 15, 1);
		testCase(new EfficientDocument("Oh,! mighty lord! I call thee to the chaple; remain silent, bow, and pray!!!"), 17, 14, 4);
